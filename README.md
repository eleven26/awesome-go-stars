...
- [casbin(stars: 15651)](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth(stars: 4307)](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go(stars: 5249)](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [oauth2(stars: 4857)](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [scs(stars: 1557)](https://github.com/alexedwards/scs) - Session Manager for HTTP servers.
...
- [cosmos-sdk(stars: 5399)](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
- [go-ethereum(stars: 43508)](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
...
- [go-chat-bot(stars: 790)](https://github.com/go-chat-bot/bot) - IRC, Slack & Telegram bot written in Go.
...
- [Kelp(stars: 1013)](https://github.com/stellar/kelp) - official trading and market-making bot for the [Stellar](https://www.stellar.org/) DEX. Works out-of-the-box, written in Golang, compatible with centralized exchanges and custom trading strategies.
...
- [telego(stars: 259)](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api(stars: 4907)](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
...
- [mage(stars: 3669)](https://github.com/magefile/mage) - Mage is a make/rake-like build tool using Go.
...
- [Task(stars: 8445)](https://github.com/go-task/task) - simple "Make" alternative.
...
- [asciigraph(stars: 2302)](https://github.com/guptarohit/asciigraph) - Go package to make lightweight ASCII line graph ╭┈╯ in command line apps with no other dependencies.
- [aurora(stars: 1343)](https://github.com/logrusorgru/aurora) - ANSI terminal colors that support fmt.Printf/Sprintf.
...
- [bubbles(stars: 3723)](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
- [bubbletea(stars: 19591)](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
...
- [go-isatty(stars: 736)](https://github.com/mattn/go-isatty) - isatty for golang.
...
- [go-prompt(stars: 4990)](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
- [gocui(stars: 9371)](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss(stars: 6156)](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
- [marker(stars: 41)](https://github.com/cyucelen/marker) - Easiest way to match and mark strings for colorful terminal outputs.
- [mpb(stars: 2083)](https://github.com/vbauerster/mpb) - Multi progress bar for terminal applications.
- [progressbar(stars: 3452)](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
- [pterm(stars: 3978)](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
- [simpletable(stars: 463)](https://github.com/alexeyco/simpletable) - Simple tables in a terminal with Go.
- [spinner(stars: 2137)](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.
...
- [termenv(stars: 1457)](https://github.com/muesli/termenv) - Advanced ANSI style & color support for your terminal applications.
- [termui(stars: 12625)](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- [uilive(stars: 1593)](https://github.com/gosuri/uilive) - Library for updating terminal output in real time.
...
- [carapace(stars: 120)](https://github.com/rsteube/carapace) - Command argument completion generator for spf13/cobra.
- [carapace-bin(stars: 289)](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
...
- [cobra(stars: 33190)](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
...
- [elvish(stars: 5123)](https://github.com/elves/elvish) - An expressive programming language and a versatile interactive shell.
...
- [go-arg(stars: 1695)](https://github.com/alexflint/go-arg) - Struct-based argument parsing in Go.
...
- [kingpin(stars: 3364)](https://github.com/alecthomas/kingpin) - Command line and flag parser supporting sub commands (superseded by `kong`; see below).
...
- [survey(stars: 3947)](https://github.com/go-survey/survey) - Build interactive and accessible prompts with full support for windows and posix terminals.
...
- [urfave/cli(stars: 20652)](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [env(stars: 3779)](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
...
- [godotenv(stars: 6575)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [koanf(stars: 1982)](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [viper(stars: 23876)](https://github.com/spf13/viper) - Go configuration with fangs.
- [xdg(stars: 436)](https://github.com/adrg/xdg) - Go implementation of the [XDG Base Directory Specification](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html) and [XDG user directories](https://wiki.archlinux.org/index.php/XDG_user_directories).
...
- [CDS(stars: 4276)](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- [drone(stars: 27215)](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [woodpecker(stars: 2952)](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- [roaring(stars: 2133)](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.

### Bit Sets

- [bitmap(stars: 227)](https://github.com/kelindar/bitmap) - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
...
- [gods(stars: 14209)](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [deque(stars: 487)](https://github.com/gammazero/deque) - Fast ring-buffer deque (double-ended queue).
...
- [bleve(stars: 9246)](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- [fastcache(stars: 1839)](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
...
- [groupcache(stars: 12290)](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [badger(stars: 12696)](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- [bbolt(stars: 6847)](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb(stars: 4195)](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover(stars: 454)](https://github.com/ostafen/clover) - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach(stars: 27690)](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
...
- [dgraph(stars: 19561)](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [diskv(stars: 1294)](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store.
- [dolt(stars: 15483)](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
...
- [godis(stars: 2983)](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
...
- [immudb(stars: 8341)](https://github.com/codenotary/immudb) - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb(stars: 26055)](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus(stars: 22587)](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- [moss(stars: 932)](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb(stars: 2991)](https://github.com/xujiajun/nutsdb) - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
- [prometheus(stars: 49709)](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- [rqlite(stars: 13971)](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- [tempdb(stars: 17)](https://github.com/rafaeljesus/tempdb) - Key-value store for temporary items.
- [tidb(stars: 34745)](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [atlas(stars: 3581)](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase(stars: 6750)](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
...
- [migrate(stars: 12138)](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
...
- [sql-migrate(stars: 2928)](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [go-mysql(stars: 4195)](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.
...
- [orchestrator(stars: 5142)](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
- [pg_timetable(stars: 900)](https://github.com/cybertec-postgresql/pg_timetable) - Advanced scheduling for PostgreSQL.
- [pgweb(stars: 8013)](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser.
...
- [vitess(stars: 16702)](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [gendry(stars: 1520)](https://github.com/didi/gendry) - Non-invasive SQL builder and powerful data binder.
...
- [goqu(stars: 1976)](https://github.com/doug-martin/goqu) - Idiomatic SQL builder and query library.
...
- [jet(stars: 1498)](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [sqlc(stars: 8946)](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
- [Squirrel(stars: 6000)](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
- [xo(stars: 3431)](https://github.com/knq/xo) - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- [go-sql-driver/mysql(stars: 13632)](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- [go-sqlite3(stars: 6826)](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- [pgx(stars: 7648)](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- [pq(stars: 8261)](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
...
- [redis(stars: 17946)](https://github.com/redis/go-redis) - Redis client for Golang.
...
- [go-elasticsearch(stars: 5124)](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
...
- [now(stars: 4224)](https://github.com/jinzhu/now) - Now is a time toolkit for golang.
...
- [dragonboat(stars: 4718)](https://github.com/lni/dragonboat) - A feature complete and high performance multi-group Raft library in Go.
- [Dragonfly(stars: 1577)](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [emitter-io(stars: 3620)](https://github.com/emitter-io/emitter) - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
- [go-kit(stars: 25357)](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro(stars: 20790)](https://github.com/micro/go-micro) - A distributed systems development framework.
...
- [go-zero(stars: 25344)](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc(stars: 679)](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
- [grpc-go(stars: 18687)](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex(stars: 6182)](https://github.com/cloudwego/kitex) - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos(stars: 21274)](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
...
- [NATS(stars: 13461)](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
...
- [raft(stars: 7364)](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [redis-lock(stars: 1109)](https://github.com/bsm/redislock) - Simplified distributed locking implementation using Redis.
...
- [rpcx(stars: 7712)](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.
...
- [email-verifier(stars: 936)](https://github.com/AfterShip/email-verifier) - A Go library for email verification without sending any emails.
...
- [go-imap(stars: 1841)](https://github.com/emersion/go-imap) - IMAP library for clients and servers.
...
- [Mailpit(stars: 2927)](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
- [cel-go(stars: 1782)](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- [expr(stars: 4307)](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
...
- [go-lua(stars: 2760)](https://github.com/Shopify/go-lua) - Port of the Lua 5.2 VM to pure Go.
...
- [goja(stars: 4218)](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
- [golua(stars: 619)](https://github.com/aarzilli/golua) - Go bindings for Lua C API.
- [gopher-lua(stars: 5612)](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
- [gval(stars: 652)](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
- [metacall(stars: 1350)](https://github.com/metacall/core) - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
- [ngaro(stars: 25)](https://github.com/db47h/ngaro) - Embeddable Ngaro VM implementation enabling scripting in Retro.
- [prolog(stars: 507)](https://github.com/ichiban/prolog) - Embeddable Prolog.
- [purl(stars: 38)](https://github.com/ian-kent/purl) - Perl 5.18.2 embedded in Go.
- [starlark-go(stars: 2042)](https://github.com/google/starlark-go) - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
...
- [gdu(stars: 2733)](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- [go-exiftool(stars: 184)](https://github.com/barasher/go-exiftool) - Go bindings for ExifTool, the well-known library used to extract as much metadata as possible (EXIF, IPTC, ...) from files (pictures, PDF, office, ...).
...
- [pdfcpu(stars: 5284)](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
- [ach(stars: 390)](https://github.com/moov-io/ach) - A reader, writer, and validator for Automated Clearing House (ACH) files.
...
- [form(stars: 625)](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- [Ebitengine(stars: 8657)](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
- [engo(stars: 1639)](https://github.com/EngoEngine/engo) - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
...
- [Leaf(stars: 4965)](https://github.com/name5566/leaf) - Lightweight game server framework.
...
- [Pitaya(stars: 1936)](https://github.com/topfreegames/pitaya) - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go(stars: 1050)](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [jennifer(stars: 2990)](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.
...
- [H3(stars: 237)](https://github.com/uber/h3-go) - Go bindings for H3, a hierarchical hexagonal geospatial indexing system.
...
- [gopherjs(stars: 12088)](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
- [ants(stars: 10923)](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
...
- [conc(stars: 7230)](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [goworker(stars: 2753)](https://github.com/benmanns/goworker) - goworker is a Go-based background worker.
...
- [tunny(stars: 3675)](https://github.com/Jeffail/tunny) - Goroutine pool for golang.
- [worker-pool(stars: 87)](https://github.com/vardius/worker-pool) - goworker is a Go simple async worker pool.
- [workerpool(stars: 1139)](https://github.com/gammazero/workerpool) - Goroutine pool that limits the concurrency of task execution, not the number of tasks queued.
...
- [app(stars: 7224)](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [fyne(stars: 21212)](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [gotk3(stars: 1945)](https://github.com/gotk3/gotk3) - Go bindings for GTK3.
...
- [qt(stars: 9945)](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [webview(stars: 11443)](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo(stars: 8627)](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [gocv(stars: 5720)](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
...
- [govips(stars: 973)](https://github.com/davidbyttow/govips) - A lightning fast image processing and resizing library for Go.
...
- [imaginary(stars: 5077)](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
...
- [picfit(stars: 1882)](https://github.com/thoas/picfit) - An image resizing server written in Go.
...
- [steganography(stars: 260)](https://github.com/auyer/steganography) - Pure Go Library for LSB steganography.
...
- [gocron(stars: 3873)](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- [GJSON(stars: 12751)](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
- [logrus(stars: 23171)](https://github.com/Sirupsen/logrus) - Structured logger for Go.
- [logrusiowriter(stars: 15)](https://github.com/cabify/logrusiowriter) - `io.Writer` implementation using [logrus](https://github.com/sirupsen/logrus) logger.
...
- [lumberjack(stars: 4230)](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- [pp(stars: 1666)](https://github.com/k0kubun/pp) - Colored pretty printer for Go language.
...
- [slog-multi(stars: 105)](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
- [spew(stars: 5696)](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tint(stars: 283)](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- [zap(stars: 19605)](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
...
- [zerolog(stars: 8797)](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- [GoLearn(stars: 9006)](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.
...
- [gorgonia(stars: 5101)](https://github.com/gorgonia/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
- [Asynq(stars: 6744)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Benthos(stars: 6552)](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
- [Bus(stars: 310)](https://github.com/mustafaturan/bus) - Minimalist message bus implementation for internal communication.
- [Centrifugo(stars: 7326)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client(stars: 4090)](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [gorush(stars: 7218)](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).
...
- [machinery(stars: 6982)](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.
...
- [Mercure(stars: 3461)](https://github.com/dunglas/mercure) - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [sarama(stars: 10312)](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
...
- [excelize(stars: 15870)](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [do(stars: 1226)](https://github.com/samber/do) - A dependency injection framework based on Generics.
- [fx(stars: 4324)](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire(stars: 11185)](https://github.com/google/wire) - Automated Initialization in Go.
...
- [ardanlabs/service(stars: 2870)](https://github.com/ardanlabs/service) - A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- [golang-standards/project-layout(stars: 41533)](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
...
- [pagoda(stars: 913)](https://github.com/mikestefanello/pagoda) - Rapid, easy full-stack web development starter kit built in Go.
...
- [base64Captcha(stars: 1841)](https://github.com/mojocn/base64Captcha) - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus(stars: 4007)](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
- [gofakeit(stars: 3266)](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
...
- [llvm(stars: 1087)](https://github.com/llir/llvm) - Library for interacting with LLVM IR in pure Go.
...
- [shoutrrr(stars: 691)](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [gojieba(stars: 2207)](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
