...
- [casbin(stars: 15230)](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth(stars: 4207)](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go(stars: 4917)](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
...
- [oauth2(stars: 4774)](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [cosmos-sdk(stars: 5277)](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
- [go-ethereum(stars: 42879)](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
...
- [tendermint(stars: 5526)](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
- [telegram-bot-api(stars: 4739)](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
...
- [wayback(stars: 1347)](https://github.com/wabarc/wayback) - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [Task(stars: 7967)](https://github.com/go-task/task) - simple "Make" alternative.
...
- [bubbles(stars: 3535)](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
...
- [gocui(stars: 9154)](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
...
- [pterm(stars: 3876)](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
- [simpletable(stars: 457)](https://github.com/alexeyco/simpletable) - Simple tables in a terminal with Go.
- [spinner(stars: 2112)](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.
...
- [termbox-go(stars: 4540)](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces.
...
- [cobra(stars: 32469)](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
...
- [Dnote(stars: 2537)](https://github.com/dnote/dnote) - A simple command line notebook with multi-device sync.
- [elvish(stars: 5080)](https://github.com/elves/elvish) - An expressive programming language and a versatile interactive shell.
...
- [urfave/cli(stars: 20377)](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv(stars: 1053)](https://github.com/ilyakaznacheev/cleanenv) - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env(stars: 3670)](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
...
- [godotenv(stars: 6352)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kong(stars: 1449)](https://github.com/alecthomas/kong) - Command-line parser with support for arbitrarily complex command-line structures and additional sources of configuration such as YAML, JSON, TOML, etc (successor to `kingpin`).
...
- [viper(stars: 23358)](https://github.com/spf13/viper) - Go configuration with fangs.
...
- [woodpecker(stars: 2770)](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- [bitset(stars: 1128)](https://github.com/bits-and-blooms/bitset) - Go package implementing bitsets.
...
- [go-datastructures(stars: 7097)](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures.
- [gods(stars: 13965)](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [golang-set(stars: 3346)](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve(stars: 9135)](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
...
- [BigCache(stars: 6618)](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
...
- [cachego(stars: 278)](https://github.com/faabiosr/cachego) - Golang Cache component for multiple drivers.
...
- [badger(stars: 12445)](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- [bbolt(stars: 6688)](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
...
- [cockroach(stars: 27395)](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
- [Coffer(stars: 33)](https://github.com/claygod/coffer) - Simple ACID key-value database that supports transactions.
- [column(stars: 1177)](https://github.com/kelindar/column) - High-performance, columnar, embeddable in-memory store with bitmap indexing and transactions.
...
- [dgraph(stars: 19423)](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
...
- [godis(stars: 2877)](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
...
- [immudb(stars: 8296)](https://github.com/codenotary/immudb) - immudb is a lightweight, high-speed immutable database for systems and applications written in Go.
- [influxdb(stars: 25761)](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
...
- [Milvus(stars: 21019)](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- [moss(stars: 927)](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb(stars: 2921)](https://github.com/xujiajun/nutsdb) - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go(stars: 879)](https://github.com/objectbox/objectbox-go) - High-performance embedded Object Database (NoSQL) with Go API.
...
- [prometheus(stars: 48916)](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- [rosedb(stars: 3835)](https://github.com/roseduan/rosedb) - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rqlite(stars: 13829)](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- [tempdb(stars: 17)](https://github.com/rafaeljesus/tempdb) - Key-value store for temporary items.
- [tidb(stars: 34366)](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics(stars: 8843)](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas(stars: 3245)](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase(stars: 6141)](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
...
- [goose(stars: 4084)](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate(stars: 11788)](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
...
- [sql-migrate(stars: 2876)](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [orchestrator(stars: 5059)](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
...
- [vitess(stars: 16469)](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [sqlc(stars: 8447)](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
- [go-sql-driver/mysql(stars: 13478)](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- [go-sqlite3(stars: 6721)](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- [pgx(stars: 7390)](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- [pq(stars: 8163)](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
...
- [redis(stars: 17514)](https://github.com/redis/go-redis) - Redis client for Golang.
...
- [go-elasticsearch(stars: 5028)](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
...
- [Dragonfly(stars: 1447)](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [go-kit(stars: 25156)](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
...
- [go-zero(stars: 24811)](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc(stars: 680)](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
- [grpc-go(stars: 18420)](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kratos(stars: 20944)](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
...
- [NATS(stars: 13014)](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
...
- [raft(stars: 7238)](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [hermes(stars: 2642)](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails.
...
- [MailHog(stars: 12214)](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- [Mailpit(stars: 2236)](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
- [SendGrid(stars: 903)](https://github.com/sendgrid/sendgrid-go) - SendGrid's Go library for sending email.
...
- [cel-go(stars: 1661)](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- [goja(stars: 3993)](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
...
- [go-multierror(stars: 1982)](https://github.com/hashicorp/go-multierror) - Go (golang) package for representing a list of errors as a single error.
...
- [afero(stars: 5238)](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
...
- [gdu(stars: 2609)](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- [decimal(stars: 5170)](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
...
- [go-money(stars: 1316)](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.
...
- [ticker(stars: 4596)](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
...
- [mo(stars: 1623)](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [nano(stars: 2404)](https://github.com/lonng/nano) - Lightweight, facility, high performance golang based game server framework.
...
- [raylib-go(stars: 1013)](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
- [termloop(stars: 1355)](https://github.com/JoelOtter/termloop) - Terminal-based game engine for Go, built on top of Termbox.
...
- [Tile38(stars: 8611)](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing.
...
- [ants(stars: 10640)](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
...
- [conc(stars: 6942)](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [fyne(stars: 20744)](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [walk(stars: 6473)](https://github.com/lxn/walk) - Windows application library kit for Go.
- [webview(stars: 11257)](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo(stars: 8510)](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
...
- [arduino-cli(stars: 3933)](https://github.com/arduino/arduino-cli) - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
...
- [imaginary(stars: 5030)](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
...
- [picfit(stars: 1860)](https://github.com/thoas/picfit) - An image resizing server written in Go.
...
- [gocron(stars: 3608)](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- [GJSON(stars: 12524)](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
- [logrus(stars: 22895)](https://github.com/Sirupsen/logrus) - Structured logger for Go.
...
- [slog(stars: 260)](https://github.com/gookit/slog) - Lightweight, configurable, extensible logger for Go.
...
- [tint(stars: 198)](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- [zap(stars: 19060)](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
...
- [gorgonia(stars: 5049)](https://github.com/gorgonia/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
- [gorse(stars: 6957)](https://github.com/zhenghaoz/gorse) - An offline recommender system backend based on collaborative filtering written in Go.
- [goscore(stars: 88)](https://github.com/asafschers/goscore) - Go Scoring API for PMML.
- [gosseract(stars: 2146)](https://github.com/otiai10/gosseract) - Go package for OCR (Optical Character Recognition), by using Tesseract C++ library.
- [libsvm(stars: 73)](https://github.com/datastream/libsvm) - libsvm golang version derived work based on LIBSVM 3.14.
- [m2cgen(stars: 2572)](https://github.com/BayesWitnesses/m2cgen) - A CLI tool to transpile trained classic ML models into a native Go code with zero dependencies, written in Python with Go language support.
...
- [Asynq(stars: 6315)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo(stars: 7171)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
- [gorush(stars: 7131)](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).
...
- [melody(stars: 3181)](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- [Mercure(stars: 3415)](https://github.com/dunglas/mercure) - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [Watermill(stars: 5778)](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [fx(stars: 4114)](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire(stars: 10892)](https://github.com/google/wire) - Automated Initialization in Go.
...
- [ardanlabs/service(stars: 2788)](https://github.com/ardanlabs/service) - A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- [golang-standards/project-layout(stars: 40405)](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
...
- [modern-go-application(stars: 1582)](https://github.com/sagikazarmark/modern-go-application) - Go application boilerplate and example applying modern practices.
- [pagoda(stars: 832)](https://github.com/mikestefanello/pagoda) - Rapid, easy full-stack web development starter kit built in Go.
...
- Mock
  ...
  - [mockery(stars: 4788)](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
