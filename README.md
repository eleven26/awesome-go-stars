...
- [langchaingo(stars: 1906)](https://github.com/tmc/langchaingo) - LangChainGo is a framework for developing applications powered by language models.
- [LocalAI(stars: 15066)](https://github.com/mudler/LocalAI) - Open Source OpenAI alternative, self-host AI models.
- [Ollama(stars: 29640)](https://github.com/jmorganca/ollama) - Run large language models locally.
...
- [GoAudio(stars: 310)](https://github.com/DylanMeeus/GoAudio) - Native Go Audio Processing Library.
...
- [casbin(stars: 16276)](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
...
- [goth(stars: 4586)](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt(stars: 631)](https://github.com/cristalhq/jwt) - Safe, simple, and fast JSON Web Tokens for Go.
...
- [jwt-go(stars: 5841)](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [keto(stars: 4400)](https://github.com/ory/keto) - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2(stars: 4999)](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
- [oidc(stars: 1067)](https://github.com/zitadel/oidc) - Easy to use OpenID Connect client and server library written for Go and certified by the OpenID Foundation
...
- [cosmos-sdk(stars: 5633)](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
- [go-ethereum(stars: 44421)](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
- [gossamer(stars: 400)](https://github.com/ChainSafe/gossamer) - A Go implementation of the Polkadot Host.
- [kubo(stars: 15587)](https://github.com/ipfs/kubo) - A blockchain framework implemented in Go. It provides content-addressable storage which can be used for decentralized storage in DApps. It is based on the IPFS protocol.
...
- [tendermint(stars: 5594)](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
...
- [echotron(stars: 299)](https://github.com/NicoNex/echotron) - An elegant and concurrent library for Telegram Bots in Go.
...
- [Golang CryptoTrading Bot(stars: 965)](https://github.com/saniales/golang-crypto-trading-bot) - A golang implementation of a console-based trading bot for cryptocurrency exchanges.
...
- [telebot(stars: 3433)](https://github.com/tucnak/telebot) - Telegram bot framework is written in Go.
- [telego(stars: 306)](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api(stars: 5197)](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
...
- [wayback(stars: 1543)](https://github.com/wabarc/wayback) - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [mage(stars: 3793)](https://github.com/magefile/mage) - Mage is a make/rake-like build tool using Go.
...
- [Task(stars: 9218)](https://github.com/go-task/task) - simple "Make" alternative.
...
- [bubbles(stars: 4181)](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
- [bubbletea(stars: 21748)](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
...
- [go-prompt(stars: 5107)](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
- [lipgloss(stars: 6794)](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar(stars: 3650)](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
- [pterm(stars: 4377)](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
- [simpletable(stars: 498)](https://github.com/alexeyco/simpletable) - Simple tables in a terminal with Go.
- [spinner(stars: 2208)](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.
...
- [termdash(stars: 2404)](https://github.com/mum4k/termdash) - Go terminal dashboard based on **termbox-go** and inspired by [termui](https://github.com/gizak/termui).
- [termenv(stars: 1572)](https://github.com/muesli/termenv) - Advanced ANSI style & color support for your terminal applications.
- [termui(stars: 12756)](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
...
- [carapace-bin(stars: 498)](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
...
- [cobra(stars: 34690)](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
...
- [go-arg(stars: 1800)](https://github.com/alexflint/go-arg) - Struct-based argument parsing in Go.
...
- [pflag(stars: 2251)](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [urfave/cli(stars: 21163)](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv(stars: 1297)](https://github.com/ilyakaznacheev/cleanenv) - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [godotenv(stars: 7048)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [kelseyhightower/envconfig(stars: 4776)](https://github.com/kelseyhightower/envconfig) - Go library for managing configuration data from environment variables.
- [koanf(stars: 2184)](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [viper(stars: 24917)](https://github.com/spf13/viper) - Go configuration with fangs.
...
- [CDS(stars: 4357)](https://github.com/ovh/cds) - Enterprise-Grade CI/CD and DevOps Automation Open Source Platform.
- [drone(stars: 30948)](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [woodpecker(stars: 3329)](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- [bitset(stars: 1214)](https://github.com/bits-and-blooms/bitset) - Go package implementing bitsets.
...
- [cuckoofilter(stars: 1039)](https://github.com/seiflotfy/cuckoofilter) - Cuckoo filter: a good alternative to a counting bloom filter implemented in Go.
...
- [gods(stars: 14828)](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
...
- [golang-set(stars: 3741)](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [fastcache(stars: 1927)](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
- [GCache(stars: 2482)](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
- [gocache(stars: 2090)](https://github.com/eko/gocache) - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [groupcache(stars: 12561)](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [theine(stars: 184)](https://github.com/Yiling-J/theine-go) - High performance, near optimal in-memory cache with proactive TTL expiration and generics.
- [timedmap(stars: 68)](https://github.com/zekroTJA/timedmap) - Map with expiring key-value pairs.
- [ttlcache(stars: 786)](https://github.com/jellydator/ttlcache) - An in-memory cache with item expiration and generics.
- [ttlcache(stars: 9)](https://github.com/cheshir/ttlcache) - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger(stars: 13024)](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
...
- [clover(stars: 525)](https://github.com/ostafen/clover) - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach(stars: 28388)](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
...
- [Databunker(stars: 1151)](https://github.com/paranoidguy/databunker) - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph(stars: 19830)](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [diskv(stars: 1318)](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store.
- [dolt(stars: 16155)](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
...
- [godis(stars: 3145)](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
- [goleveldb(stars: 5925)](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.
...
- [influxdb(stars: 27018)](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
- [ledisdb(stars: 4031)](https://github.com/siddontang/ledisdb) - Ledisdb is a high performance NoSQL like Redis based on LevelDB.
...
- [lotusdb(stars: 1868)](https://github.com/flower-corp/lotusdb) - Fast k/v database compatible with lsm and b+tree.
- [Milvus(stars: 24911)](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- [moss(stars: 940)](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb(stars: 3215)](https://github.com/xujiajun/nutsdb) - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
...
- [prometheus(stars: 51256)](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- [rqlite(stars: 14393)](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- [tempdb(stars: 17)](https://github.com/rafaeljesus/tempdb) - Key-value store for temporary items.
- [tidb(stars: 35490)](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics(stars: 10075)](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas(stars: 4237)](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase(stars: 8767)](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
- [darwin(stars: 140)](https://github.com/GuiaBolso/darwin) - Database schema evolution library for Go.
- [dbmate(stars: 4087)](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
...
- [goose(stars: 4931)](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate(stars: 13137)](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
...
- [skeema(stars: 1199)](https://github.com/skeema/skeema) - Pure-SQL schema management system for MySQL, with support for sharding and external online schema change tools.
...
- [chproxy(stars: 1164)](https://github.com/Vertamedia/chproxy) - HTTP proxy for ClickHouse database.
...
- [go-mysql(stars: 4311)](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.
...
- [kingshard(stars: 6299)](https://github.com/flike/kingshard) - kingshard is a high performance proxy for MySQL powered by Golang.
...
- [orchestrator(stars: 5344)](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
- [pg_timetable(stars: 982)](https://github.com/cybertec-postgresql/pg_timetable) - Advanced scheduling for PostgreSQL.
...
- [vitess(stars: 17284)](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [buildsqlx(stars: 135)](https://github.com/arthurkushman/buildsqlx) - Go database query builder library for PostgreSQL.
...
- [gendry(stars: 1555)](https://github.com/didi/gendry) - Non-invasive SQL builder and powerful data binder.
...
- [sqlc(stars: 9737)](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
- [Squirrel(stars: 6292)](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
...
- [go-sql-driver/mysql(stars: 13933)](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- [go-sqlite3(stars: 7139)](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- [pgx(stars: 8762)](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- [pq(stars: 8511)](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
...
- [mongo-go-driver(stars: 7774)](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.
...
- [redis(stars: 18565)](https://github.com/redis/go-redis) - Redis client for Golang.
...
- [go-elasticsearch(stars: 5315)](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
...
- [carbon(stars: 4198)](https://github.com/golang-module/carbon) - A simple, semantic and developer-friendly golang package for datetime.
...
- [dateparse(stars: 1948)](https://github.com/araddon/dateparse) - Parse date's without knowing format in advance.
...
- [now(stars: 4309)](https://github.com/jinzhu/now) - Now is a time toolkit for golang.
...
- [Dragonfly(stars: 1807)](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [gleam(stars: 3287)](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
...
- [go-doudou(stars: 1287)](https://github.com/unionj-cloud/go-doudou) - A gossip protocol and OpenAPI 3.0 spec based decentralized microservice framework. Built-in go-doudou cli focusing on low-code and rapid dev can power up your productivity.
...
- [go-kit(stars: 25804)](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro(stars: 21110)](https://github.com/micro/go-micro) - A distributed systems development framework.
...
- [go-zero(stars: 26756)](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc(stars: 683)](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
- [grpc-go(stars: 19336)](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kratos(stars: 21928)](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge(stars: 2510)](https://github.com/liftbridge-io/liftbridge) - Lightweight, fault-tolerant message streams for NATS.
- [lura(stars: 5867)](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
- [micro(stars: 11942)](https://github.com/micro/micro) - A distributed systems runtime for the cloud and beyond.
- [NATS(stars: 14106)](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
...
- [raft(stars: 7612)](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
...
- [redis-lock(stars: 1218)](https://github.com/bsm/redislock) - Simplified distributed locking implementation using Redis.
...
- [trpc-go(stars: 565)](https://github.com/trpc-group/trpc-go) - The Go language implementation of tRPC, which is a pluggable, high-performance RPC framework.
...
- [email(stars: 2496)](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.
...
- [go-message(stars: 344)](https://github.com/emersion/go-message) - Streaming library for the Internet Message Format and mail messages.
...
- [Maddy(stars: 4468)](https://github.com/foxcpp/maddy) - All-in-one (SMTP, IMAP, DKIM, DMARC, MTA-STS, DANE) email server
...
- [MailHog(stars: 12921)](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- [Mailpit(stars: 3766)](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
- [expr(stars: 4940)](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
...
- [goja(stars: 4535)](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
- [golua(stars: 630)](https://github.com/aarzilli/golua) - Go bindings for Lua C API.
- [gopher-lua(stars: 5813)](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
- [gval(stars: 684)](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
- [metacall(stars: 1431)](https://github.com/metacall/core) - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
- [eris(stars: 1382)](https://github.com/rotisserie/eris) - A better way to handle, trace, and log errors in Go. Compatible with the standard error library and github.com/pkg/errors.
...
- [errors(stars: 1883)](https://github.com/cockroachdb/errors) - Go error library with error portability over the network.
...
- [tracerr(stars: 866)](https://github.com/ztrue/tracerr) - Golang errors with stack trace and source fragments.
...
- [afero(stars: 5533)](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
...
- [copy(stars: 637)](https://github.com/otiai10/copy) - Copy directory recursively.
...
- [gdu(stars: 2975)](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- [pdfcpu(stars: 5783)](https://github.com/pdfcpu/pdfcpu) - PDF processor.
...
- [bbgo(stars: 1024)](https://github.com/c9s/bbgo) - A crypto trading bot framework written in Go. Including common crypto exchange API, standard indicators, back-testing and many built-in strategies.
...
- [decimal(stars: 5594)](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
...
- [form(stars: 657)](https://github.com/go-playground/form) - Decodes url.Values into Go value(s) and Encodes Go value(s) into url.Values. Dual Array and Full map support.
...
- [mo(stars: 2053)](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine(stars: 9307)](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
...
- [g3n(stars: 2559)](https://github.com/g3n/engine) - Go 3D Game Engine.
...
- [goworld(stars: 2440)](https://github.com/xiaonanln/goworld) - Scalable game server engine, featuring space-entity framework and hot-swapping.
...
- [nano(stars: 2579)](https://github.com/lonng/nano) - Lightweight, facility, high performance golang based game server framework.
- [Oak(stars: 1469)](https://github.com/oakmound/oak) - Pure Go game engine.
- [Pitaya(stars: 2056)](https://github.com/topfreegames/pitaya) - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
- [Pixel(stars: 4363)](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go.
...
- [raylib-go(stars: 1174)](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
- [termloop(stars: 1379)](https://github.com/JoelOtter/termloop) - Terminal-based game engine for Go, built on top of Termbox.
...
- [go-enum(stars: 598)](https://github.com/abice/go-enum) - Code generation for enums from code comments.
...
- [jennifer(stars: 3106)](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.
- [oapi-codegen(stars: 4678)](https://github.com/deepmap/oapi-codegen) - This package contains a set of utilities for generating Go boilerplate code for services based on OpenAPI 3.0 API definitions.
...
- [Tile38(stars: 8792)](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing.
...
- [gopherjs(stars: 12242)](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
- [ants(stars: 11559)](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
...
- [conc(stars: 7909)](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [app(stars: 7488)](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
...
- [fyne(stars: 22231)](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [gotk3(stars: 1976)](https://github.com/gotk3/gotk3) - Go bindings for GTK3.
...
- [qt(stars: 10089)](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [walk(stars: 6642)](https://github.com/lxn/walk) - Windows application library kit for Go.
- [webview(stars: 11749)](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo(stars: 8944)](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray(stars: 3008)](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area.
...
- [arduino-cli(stars: 4086)](https://github.com/arduino/arduino-cli) - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
- [emgo(stars: 1039)](https://github.com/ziutek/emgo) - Go-like language for programming embedded systems (e.g. STM32 MCU).
- [ghw(stars: 1537)](https://github.com/jaypipes/ghw) - Golang hardware discovery/inspection library.
- [go-osc(stars: 180)](https://github.com/hypebeast/go-osc) - Open Sound Control (OSC) bindings for Go.
...
- [canvas(stars: 1378)](https://github.com/tdewolff/canvas) - Vector graphics to PDF, SVG or rasterized image.
...
- [gg(stars: 4185)](https://github.com/fogleman/gg) - 2D rendering in pure Go.
...
- [go-webp(stars: 175)](https://github.com/kolesa-team/go-webp) - Library for encode and decode webp pictures, using libwebp.
...
- [govips(stars: 1058)](https://github.com/davidbyttow/govips) - A lightning fast image processing and resizing library for Go.
- [gowitness(stars: 2519)](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
...
- [imaginary(stars: 5209)](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
...
- [picfit(stars: 1943)](https://github.com/thoas/picfit) - An image resizing server written in Go.
...
- [Dagu(stars: 1000)](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-quartz(stars: 1565)](https://github.com/reugn/go-quartz) - Simple, zero-dependency scheduling library for Go.
- [gocron(stars: 4489)](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- [fastjson(stars: 2072)](https://github.com/valyala/fastjson) - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
...
- [OjG(stars: 755)](https://github.com/ohler55/ojg) - Optimized JSON for Go is a high performance parser with a variety of additional JSON tools including JSONPath.
...
- [logrus(stars: 23646)](https://github.com/Sirupsen/logrus) - Structured logger for Go.
...
- [lumberjack(stars: 4428)](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- [spew(stars: 5810)](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [zap(stars: 20275)](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
...
- [zerolog(stars: 9223)](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- [GoLearn(stars: 9082)](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.
...
- [APNs2(stars: 2897)](https://github.com/sideshow/apns2) - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
- [Asynq(stars: 7950)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo(stars: 7590)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client(stars: 4271)](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
