...
- [id3v2(stars: 295)](https://github.com/bogem/id3v2) - ID3 decoding and encoding library for Go.
...
- [Oto(stars: 1321)](https://github.com/hajimehoshi/oto) - A low-level library to play sound on multiple platforms.
...
- [casbin(stars: 15535)](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, and ABAC.
- [cookiestxt(stars: 12)](https://github.com/mengzhuo/cookiestxt) - provides a parser of cookies.txt file format.
- [go-guardian(stars: 484)](https://github.com/shaj13/go-guardian) - Go-Guardian is a golang library that provides a simple, clean, and idiomatic way to create powerful modern API and web authentication that supports LDAP, Basic, Bearer token, and Certificate based authentication.
...
- [goth(stars: 4286)](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple providers out of the box.
...
- [jwt-go(stars: 5127)](https://github.com/golang-jwt/jwt) - A full featured implementation of JSON Web Tokens (JWT). This library supports the parsing and verification as well as the generation and signing of JWTs.
- [keto(stars: 4159)](https://github.com/ory/keto) - Open Source (Go) implementation of "Zanzibar: Google's Consistent, Global Authorization System". Ships gRPC, REST APIs, newSQL, and an easy and granular permission language. Supports ACL, RBAC, and other access models.
...
- [oauth2(stars: 4822)](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine, and App Engine support.
...
- [scs(stars: 1545)](https://github.com/alexedwards/scs) - Session Manager for HTTP servers.
...
- [cosmos-sdk(stars: 5374)](https://github.com/cosmos/cosmos-sdk) - A Framework for Building Public Blockchains in the Cosmos Ecosystem.
- [go-ethereum(stars: 43288)](https://github.com/ethereum/go-ethereum) - Official Go implementation of the Ethereum protocol.
...
- [bot(stars: 164)](https://github.com/go-telegram/bot) - Zero-dependencies Telegram Bot library with additional UI components
...
- [telebot(stars: 3202)](https://github.com/tucnak/telebot) - Telegram bot framework is written in Go.
- [telego(stars: 237)](https://github.com/mymmrac/telego) - Telegram Bot API library for Golang with full one-to-one API implementation.
- [telegram-bot-api(stars: 4848)](https://github.com/Syfaro/telegram-bot-api) - Simple and clean Telegram bot client.
...
- [wayback(stars: 1389)](https://github.com/wabarc/wayback) - A bot for Telegram, Mastodon, Slack, and other messaging platforms archives webpages.
...
- [mage(stars: 3636)](https://github.com/magefile/mage) - Mage is a make/rake-like build tool using Go.
...
- [Task(stars: 8283)](https://github.com/go-task/task) - simple "Make" alternative.
...
- [bubbles(stars: 3665)](https://github.com/charmbracelet/bubbles) - TUI components for bubbletea.
- [bubbletea(stars: 19303)](https://github.com/charmbracelet/bubbletea) - Go framework to build terminal apps, based on The Elm Architecture.
...
- [go-isatty(stars: 730)](https://github.com/mattn/go-isatty) - isatty for golang.
...
- [go-prompt(stars: 4978)](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
- [gocui(stars: 9322)](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
...
- [lipgloss(stars: 6105)](https://github.com/charmbracelet/lipgloss) - Declaratively define styles for color, format and layout in the terminal.
...
- [progressbar(stars: 3429)](https://github.com/schollz/progressbar) - Basic thread-safe progress bar that works in every OS.
- [pterm(stars: 3942)](https://github.com/pterm/pterm) - A library to beautify console output on every platform with many combinable components.
...
- [termui(stars: 12604)](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).
- [uilive(stars: 1589)](https://github.com/gosuri/uilive) - Library for updating terminal output in real time.
- [uiprogress(stars: 2038)](https://github.com/gosuri/uiprogress) - Flexible library to render progress bars in terminal applications.
...
- [carapace-bin(stars: 266)](https://github.com/rsteube/carapace-bin) - Multi-shell multi-command argument completer.
- [carapace-spec(stars: 7)](https://github.com/rsteube/carapace-spec) - Define simple completions using a spec file.
- [cli(stars: 690)](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang struct tags.
...
- [cobra(stars: 32932)](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.
...
- [Dnote(stars: 2556)](https://github.com/dnote/dnote) - A simple command line notebook with multi-device sync.
- [elvish(stars: 5115)](https://github.com/elves/elvish) - An expressive programming language and a versatile interactive shell.
...
- [go-flags(stars: 2422)](https://github.com/jessevdk/go-flags) - go command line option parser.
...
- [pflag(stars: 2151)](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
...
- [survey(stars: 3918)](https://github.com/go-survey/survey) - Build interactive and accessible prompts with full support for windows and posix terminals.
...
- [urfave/cli(stars: 20546)](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
- [cleanenv(stars: 1113)](https://github.com/ilyakaznacheev/cleanenv) - Minimalistic configuration reader (from files, ENV, and wherever you want).
...
- [env(stars: 3752)](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
...
- [godotenv(stars: 6506)](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`).
...
- [ini(stars: 3289)](https://github.com/go-ini/ini) - Go package to read and write INI files.
...
- [kelseyhightower/envconfig(stars: 4624)](https://github.com/kelseyhightower/envconfig) - Go library for managing configuration data from environment variables.
- [koanf(stars: 1949)](https://github.com/knadh/koanf) - Light weight, extensible library for reading config in Go applications. Built in support for JSON, TOML, YAML, env, command line.
...
- [viper(stars: 23702)](https://github.com/spf13/viper) - Go configuration with fangs.
...
- [drone(stars: 27162)](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.
...
- [woodpecker(stars: 2908)](https://github.com/woodpecker-ci/woodpecker) - Woodpecker is a community fork of the Drone CI system.
...
- [roaring(stars: 2103)](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.

### Bit Sets

- [bitmap(stars: 225)](https://github.com/kelindar/bitmap) - Dense, zero-allocation, SIMD-enabled bitmap/bitset in Go.
- [bitset(stars: 1142)](https://github.com/bits-and-blooms/bitset) - Go package implementing bitsets.

### Bloom and Cuckoo Filters

- [bloom(stars: 2009)](https://github.com/bits-and-blooms/bloom) - Go package implementing Bloom filters.
...
- [go-datastructures(stars: 7143)](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures.
- [gods(stars: 14128)](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
- [gostl(stars: 901)](https://github.com/liyue201/gostl) - Data structure and algorithm library for go, designed to provide functions similar to C++ STL.
...
- [goconcurrentqueue(stars: 310)](https://github.com/enriquebris/goconcurrentqueue) - Concurrent FIFO queue.
...
- [golang-set(stars: 3410)](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
...
- [bleve(stars: 9199)](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
- [go-adaptive-radix-tree(stars: 294)](https://github.com/plar/go-adaptive-radix-tree) - Go implementation of Adaptive Radix Tree.
...
- [BigCache(stars: 6710)](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
...
- [fastcache(stars: 1817)](https://github.com/VictoriaMetrics/fastcache) - fast thread-safe inmemory cache for big number of entries. Minimizes GC overhead.
- [GCache(stars: 2410)](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
- [gocache(stars: 1907)](https://github.com/eko/gocache) - A complete Go cache library with multiple stores (memory, memcache, redis, ...), chainable, loadable, metrics cache and more.
...
- [groupcache(stars: 12255)](https://github.com/golang/groupcache) - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
...
- [ttlcache(stars: 687)](https://github.com/jellydator/ttlcache) - An in-memory cache with item expiration and generics.
- [ttlcache(stars: 9)](https://github.com/cheshir/ttlcache) - In-memory key value storage with TTL for each record.

### Databases Implemented in Go

- [badger(stars: 12612)](https://github.com/dgraph-io/badger) - Fast key-value store in Go.
- [bbolt(stars: 6798)](https://github.com/etcd-io/bbolt) - An embedded key/value database for Go.
- [Bitcask](https://git.mills.io/prologic/bitcask) - Bitcask is an embeddable, persistent and fast key-value (KV) database written in pure Go with predictable read/write performance, low latency and high throughput thanks to the bitcask on-disk layout (LSM+WAL).
- [buntdb(stars: 4177)](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
- [clover(stars: 448)](https://github.com/ostafen/clover) - A lightweight document-oriented NoSQL database written in pure Golang.
- [cockroach(stars: 27595)](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
...
- [Databunker(stars: 1107)](https://github.com/paranoidguy/databunker) - Personally identifiable information (PII) storage service built to comply with GDPR and CCPA.
- [dgraph(stars: 19519)](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
- [diskv(stars: 1292)](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store.
- [dolt(stars: 15419)](https://github.com/dolthub/dolt) - Dolt – It's Git for Data.
...
- [godis(stars: 2958)](https://github.com/hdt3213/godis) - A Golang implemented high-performance Redis server and cluster.
- [goleveldb(stars: 5809)](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.
...
- [influxdb(stars: 25964)](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics.
...
- [lotusdb(stars: 1211)](https://github.com/flower-corp/lotusdb) - Fast k/v database compatible with lsm and b+tree.
- [Milvus(stars: 22122)](https://github.com/milvus-io/milvus) - Milvus is a vector database for embedding management, analytics and search.
- [moss(stars: 932)](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
- [nutsdb(stars: 2970)](https://github.com/xujiajun/nutsdb) - Nutsdb is a simple, fast, embeddable, persistent key/value store written in pure Go. It supports fully serializable transactions and many data structures such as list, set, sorted set.
- [objectbox-go(stars: 898)](https://github.com/objectbox/objectbox-go) - High-performance embedded Object Database (NoSQL) with Go API.
...
- [prometheus(stars: 49465)](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- [rosedb(stars: 3920)](https://github.com/roseduan/rosedb) - An embedded k-v database based on LSM+WAL, supports string, list, hash, set, zset.
- [rqlite(stars: 13931)](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
- [tempdb(stars: 17)](https://github.com/rafaeljesus/tempdb) - Key-value store for temporary items.
- [tidb(stars: 34613)](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.
...
- [VictoriaMetrics(stars: 9062)](https://github.com/VictoriaMetrics/VictoriaMetrics) - fast, resource-effective and scalable open source time series database. May be used as long-term remote storage for Prometheus. Supports PromQL.

### Database Schema Migration

- [atlas(stars: 3480)](https://github.com/ariga/atlas) - A Database Toolkit. A CLI designed to help companies better work with their data.
...
- [bytebase(stars: 6494)](https://github.com/bytebase/bytebase) - Safe database schema change and version control for DevOps teams.
- [darwin(stars: 135)](https://github.com/GuiaBolso/darwin) - Database schema evolution library for Go.
- [dbmate(stars: 3637)](https://github.com/amacneil/dbmate) - A lightweight, framework-agnostic database migration tool.
...
- [goose(stars: 4241)](https://github.com/pressly/goose) - Database migration tool. You can manage your database's evolution by creating incremental SQL or Go scripts.
...
- [migrate(stars: 12013)](https://github.com/golang-migrate/migrate) - Database migrations. CLI and Golang library.
...
- [sql-migrate(stars: 2914)](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.
...
- [clickhouse-bulk(stars: 430)](https://github.com/nikepan/clickhouse-bulk) - Collects small inserts and sends big requests to ClickHouse servers.
...
- [go-mysql(stars: 4170)](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.
...
- [orchestrator(stars: 5114)](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer.
...
- [pREST(stars: 3867)](https://github.com/prest/prest) - Simplify and accelerate development, ⚡ instant, realtime, high-performance on any Postgres application, existing or new.
...
- [vitess(stars: 16627)](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.
...
- [gendry(stars: 1510)](https://github.com/didi/gendry) - Non-invasive SQL builder and powerful data binder.
...
- [jet(stars: 1437)](https://github.com/go-jet/jet) - Framework for writing type-safe SQL queries in Go, with ability to easily convert database query result into desired arbitrary object structure.
...
- [ozzo-dbx(stars: 611)](https://github.com/go-ozzo/ozzo-dbx) - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
...
- [sqlc(stars: 8795)](https://github.com/kyleconroy/sqlc) - Generate type-safe code from SQL.
...
- [Squirrel(stars: 5948)](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
- [xo(stars: 3414)](https://github.com/knq/xo) - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
- [go-transaction-manager(stars: 68)](https://github.com/avito-tech/go-transaction-manager) - Transaction manager with multiple adapters (sql, sqlx, gorm, mongo, ...) controls transaction boundaries.
- [gokv(stars: 572)](https://github.com/philippgille/gokv) - Simple key-value store abstraction and implementations for Go (Redis, Consul, etcd, bbolt, BadgerDB, LevelDB, Memcached, DynamoDB, S3, PostgreSQL, MongoDB, CockroachDB and many more).
...
- [go-sql-driver/mysql(stars: 13585)](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
- [go-sqlite3(stars: 6794)](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- [pgx(stars: 7568)](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
...
- [pq(stars: 8230)](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
...
- [mgm(stars: 680)](https://github.com/kamva/mgm) - MongoDB model-based ODM for Go (based on official MongoDB driver).
...
- [mongo-go-driver(stars: 7564)](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.
...
- [redis(stars: 17734)](https://github.com/redis/go-redis) - Redis client for Golang.
...
- [elasticsql(stars: 1079)](https://github.com/cch123/elasticsql) - Convert sql to elasticsearch dsl in Go.
- [elastigo(stars: 951)](https://github.com/mattbaird/elastigo) - Elasticsearch client library.
- [go-elasticsearch(stars: 5091)](https://github.com/elastic/go-elasticsearch) - Official Elasticsearch client for Go.
...
- [carbon(stars: 3377)](https://github.com/golang-module/carbon) - A simple, semantic and developer-friendly golang package for datetime.
- [carbon(stars: 764)](https://github.com/uniplaces/carbon) - Simple Time extension with a lot of util methods, ported from PHP Carbon library.
...
- [dragonboat(stars: 4700)](https://github.com/lni/dragonboat) - A feature complete and high performance multi-group Raft library in Go.
- [Dragonfly(stars: 1535)](https://github.com/dragonflyoss/Dragonfly2) - Provide efficient, stable and secure file distribution and image acceleration based on p2p technology to be the best practice and standard solution in cloud native architectures.
...
- [emitter-io(stars: 3609)](https://github.com/emitter-io/emitter) - High performance, distributed, secure and low latency publish-subscribe platform built with MQTT, Websockets and love.
...
- [go-health(stars: 709)](https://github.com/InVisionApp/go-health) - Library for enabling asynchronous dependency health checks in your service.
- [go-jump(stars: 368)](https://github.com/dgryski/go-jump) - Port of Google's "Jump" Consistent Hash function.
- [go-kit(stars: 25298)](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
- [go-micro(stars: 20730)](https://github.com/micro/go-micro) - A distributed systems development framework.
...
- [go-zero(stars: 25166)](https://github.com/tal-tech/go-zero) - A web and rpc framework. It's born to ensure the stability of the busy sites with resilient design. Builtin goctl greatly improves the development productivity.
- [gorpc(stars: 680)](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
- [grpc-go(stars: 18606)](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
...
- [Kitex(stars: 6137)](https://github.com/cloudwego/kitex) - A high-performance and strong-extensibility Golang RPC framework that helps developers build microservices. If the performance and extensibility are the main concerns when you develop microservices, Kitex can be a good choice.
- [Kratos(stars: 21173)](https://github.com/go-kratos/kratos) - A modular-designed and easy-to-use microservices framework in Go.
- [liftbridge(stars: 2473)](https://github.com/liftbridge-io/liftbridge) - Lightweight, fault-tolerant message streams for NATS.
- [lura(stars: 5679)](https://github.com/luraproject/lura) - Ultra performant API Gateway framework with middlewares.
- [micro(stars: 11845)](https://github.com/micro/micro) - A distributed systems runtime for the cloud and beyond.
- [NATS(stars: 13375)](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
...
- [raft(stars: 7325)](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
- [raft(stars: 306)](https://github.com/etcd-io/raft) - Go implementation of the Raft consensus protocol, by CoreOS.
- [rain(stars: 859)](https://github.com/cenkalti/rain) - BitTorrent client and library.
- [redis-lock(stars: 1089)](https://github.com/bsm/redislock) - Simplified distributed locking implementation using Redis.
- [resgate](https://resgate.io/) - Realtime API Gateway for building REST, real time, and RPC APIs, where all clients are synchronized seamlessly.
- [ringpop-go(stars: 787)](https://github.com/uber/ringpop-go) - Scalable, fault-tolerant application-layer sharding for Go applications.
- [rpcx(stars: 7690)](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.
...
- [torrent(stars: 4883)](https://github.com/anacrolix/torrent) - BitTorrent client package.
...
- [email(stars: 2393)](https://github.com/jordan-wright/email) - A robust and flexible email library for Go.
- [email-verifier(stars: 927)](https://github.com/AfterShip/email-verifier) - A Go library for email verification without sending any emails.
...
- [go-imap(stars: 1821)](https://github.com/emersion/go-imap) - IMAP library for clients and servers.
- [go-mail(stars: 313)](https://github.com/wneessen/go-mail) - A simple Go library for sending mails in Go.
...
- [MailHog(stars: 12403)](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface.
- [Mailpit(stars: 2729)](https://github.com/axllent/mailpit) - Email and SMTP testing tool for developers.
...
- [SendGrid(stars: 918)](https://github.com/sendgrid/sendgrid-go) - SendGrid's Go library for sending email.
...
- [cel-go(stars: 1720)](https://github.com/google/cel-go) - Fast, portable, non-Turing complete expression evaluation with gradual typing.
...
- [expr(stars: 4017)](https://github.com/antonmedv/expr) - Expression evaluation engine for Go: fast, non-Turing complete, dynamic typing, static typing.
...
- [goja(stars: 4129)](https://github.com/dop251/goja) - ECMAScript 5.1(+) implementation in Go.
- [golua(stars: 618)](https://github.com/aarzilli/golua) - Go bindings for Lua C API.
- [gopher-lua(stars: 5590)](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go.
- [gval(stars: 645)](https://github.com/PaesslerAG/gval) - A highly customizable expression language written in Go.
- [metacall(stars: 1339)](https://github.com/metacall/core) - Cross-platform Polyglot Runtime which supports NodeJS, JavaScript, TypeScript, Python, Ruby, C#, WebAssembly, Java, Cobol and more.
...
- [starlark-go(stars: 2017)](https://github.com/google/starlark-go) - Go implementation of Starlark: Python-like language with deterministic evaluation and hermetic execution.
- [tengo(stars: 3249)](https://github.com/d5/tengo) - Bytecode compiled script language for Go.
...
- [errors(stars: 1715)](https://github.com/cockroachdb/errors) - Go error library with error portability over the network.
- [errorx(stars: 998)](https://github.com/joomcode/errorx) - A feature rich error package with stack traces, composition of errors and more.
...
- [go-multierror(stars: 2008)](https://github.com/hashicorp/go-multierror) - Go (golang) package for representing a list of errors as a single error.
- [oops(stars: 72)](https://github.com/samber/oops) - Error handling with context, stack trace and source fragments.
...
- [afs(stars: 257)](https://github.com/viant/afs) - Abstract File Storage (mem, scp, zip, tar, cloud: s3, gs) for Go.
...
- [checksum(stars: 89)](https://github.com/codingsince1985/checksum) - Compute message digest, like MD5, SHA256, SHA1, CRC or BLAKE2s, for large files.
...
- [gdu(stars: 2698)](https://github.com/dundee/gdu) - Disk usage analyzer with console interface.
...
- [pdfcpu(stars: 5199)](https://github.com/pdfcpu/pdfcpu) - PDF processor.
- [skywalker(stars: 91)](https://github.com/dixonwille/skywalker) - Package to allow one to concurrently go through a filesystem with ease.
...
- [vfs(stars: 249)](https://github.com/C2FO/vfs) - A pluggable, extensible, and opinionated set of filesystem functionality for Go across a number of filesystem types such as os, S3, and GCS.
...
- [decimal(stars: 5274)](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers.
...
- [go-money(stars: 1344)](https://github.com/rhymond/go-money) - Implementation of Fowler's Money pattern.
...
- [ticker(stars: 4625)](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
...
- [gorilla/csrf(stars: 903)](https://github.com/gorilla/csrf) - CSRF protection for Go web applications & services.
...
- [fp-go(stars: 243)](https://github.com/repeale/fp-go) - Collection of Functional Programming helpers powered by Golang 1.18+ generics.
...
- [mo(stars: 1706)](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine(stars: 8573)](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
...
- [go-sdl2(stars: 2008)](https://github.com/veandco/go-sdl2) - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
...
- [nano(stars: 2439)](https://github.com/lonng/nano) - Lightweight, facility, high performance golang based game server framework.
- [Oak(stars: 1431)](https://github.com/oakmound/oak) - Pure Go game engine.
- [Pitaya(stars: 1907)](https://github.com/topfreegames/pitaya) - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [raylib-go(stars: 1038)](https://github.com/gen2brain/raylib-go) - Go bindings for [raylib](https://www.raylib.com/), a simple and easy-to-use library to learn videogames programming.
...
- [goverter(stars: 299)](https://github.com/jmattheis/goverter) - Generate converters by defining an interface.
...
- [jennifer(stars: 2971)](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.
...
- [gopherjs(stars: 12064)](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
...
- [ants(stars: 10831)](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
- [artifex(stars: 177)](https://github.com/borderstech/artifex) - Simple in-memory job queue for Golang using worker-based dispatching.
...
- [conc(stars: 7136)](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [flowmatic(stars: 154)](https://github.com/carlmjohnson/flowmatic) - Structured concurrency made easy.
...
- [pond(stars: 948)](https://github.com/alitto/pond) - Minimalistic and High-performance goroutine worker pool written in Go.
...
- [tunny(stars: 3656)](https://github.com/Jeffail/tunny) - Goroutine pool for golang.
...
- [app(stars: 7184)](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
- [fyne(stars: 21050)](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [gotk3(stars: 1936)](https://github.com/gotk3/gotk3) - Go bindings for GTK3.
...
- [qt(stars: 9920)](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
- [ui(stars: 8288)](https://github.com/andlabs/ui) - Platform-native GUI library for Go. Cross platform.
...
- [webview(stars: 11380)](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [robotgo(stars: 8578)](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation. Control the mouse, keyboard and other.
- [systray(stars: 2860)](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area.
...
- [zenity(stars: 527)](https://github.com/ncruces/zenity) - Cross-platform Go library and CLI to create simple dialogs that interact graphically with the user.
...
- [arduino-cli(stars: 3977)](https://github.com/arduino/arduino-cli) - Official Arduino CLI and library. Can run standalone, or be incorporated into larger Go projects.
- [emgo(stars: 1029)](https://github.com/ziutek/emgo) - Go-like language for programming embedded systems (e.g. STM32 MCU).
- [ghw(stars: 1459)](https://github.com/jaypipes/ghw) - Golang hardware discovery/inspection library.
- [go-osc(stars: 175)](https://github.com/hypebeast/go-osc) - Open Sound Control (OSC) bindings for Go.
- [go-rpio(stars: 2039)](https://github.com/stianeikeland/go-rpio) - GPIO for Go, doesn't require cgo.
...
- [bimg(stars: 2335)](https://github.com/h2non/bimg) - Small package for fast and efficient image processing using libvips.
...
- [gocv(stars: 5657)](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
- [goimagehash(stars: 631)](https://github.com/corona10/goimagehash) - Go Perceptual image hashing package.
...
- [govips(stars: 952)](https://github.com/davidbyttow/govips) - A lightning fast image processing and resizing library for Go.
- [gowitness(stars: 2304)](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
...
- [imaginary(stars: 5056)](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
...
- [ln(stars: 3191)](https://github.com/fogleman/ln) - 3D line art rendering in Go.
...
- [ekuiper(stars: 1108)](https://github.com/lf-edge/ekuiper) - Lightweight data stream processing engine for IoT edge.
...
- [gatt(stars: 1077)](https://github.com/paypal/gatt) - Gatt is a Go package for building Bluetooth Low Energy peripherals.
...
- [mainflux(stars: 2119)](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.
...
- [Dagu(stars: 846)](https://github.com/dagu-go/dagu) - No-code workflow executor. it executes DAGs defined in a simple YAML format.
...
- [go-quartz(stars: 1380)](https://github.com/reugn/go-quartz) - Simple, zero-dependency scheduling library for Go.
- [gocron(stars: 3786)](https://github.com/go-co-op/gocron) - Easy and fluent Go job scheduling. This is an actively maintained fork of [jasonlvhit/gocron](https://github.com/jasonlvhit/gocron).
...
- [fastjson(stars: 1965)](https://github.com/valyala/fastjson) - Fast JSON parser and validator for Go. No custom structs, no code generation, no reflection.
- [gjo(stars: 119)](https://github.com/skanehira/gjo) - Small utility to create JSON objects.
- [GJSON(stars: 12676)](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
- [logrus(stars: 23090)](https://github.com/Sirupsen/logrus) - Structured logger for Go.
...
- [lumberjack(stars: 4196)](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
- [slog(stars: 274)](https://github.com/gookit/slog) - Lightweight, configurable, extensible logger for Go.
- [slog-formatter(stars: 27)](https://github.com/samber/slog-formatter) - Common formatters for slog and helpers to build your own.
- [slog-multi(stars: 86)](https://github.com/samber/slog-multi) - Chain of slog.Handler (pipeline, fanout...).
- [spew(stars: 5679)](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [tint(stars: 257)](https://github.com/lmittmann/tint) - A slog.Handler that writes tinted logs.
...
- [zap(stars: 19332)](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
...
- [zerolog(stars: 8694)](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- [GoLearn(stars: 8990)](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.
- [golinear(stars: 45)](https://github.com/danieldk/golinear) - liblinear bindings for Go.
- [GoMind(stars: 62)](https://github.com/surenderthakran/gomind) - A simplistic Neural Network Library in Go.
...
- [gorse(stars: 7527)](https://github.com/zhenghaoz/gorse) - An offline recommender system backend based on collaborative filtering written in Go.
...
- [amqp(stars: 957)](https://github.com/rabbitmq/amqp091-go) - Go RabbitMQ Client Library.
- [APNs2(stars: 2847)](https://github.com/sideshow/apns2) - HTTP/2 Apple Push Notification provider for Go — Send push notifications to iOS, tvOS, Safari and OSX apps.
- [Asynq(stars: 6582)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Benthos(stars: 6480)](https://github.com/Jeffail/benthos) - A message streaming bridge between a range of protocols.
- [Bus(stars: 308)](https://github.com/mustafaturan/bus) - Minimalist message bus implementation for internal communication.
- [Centrifugo(stars: 7273)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
- [Confluent Kafka Golang Client(stars: 4069)](https://github.com/confluentinc/confluent-kafka-go) - confluent-kafka-go is Confluent's Golang client for Apache Kafka and the Confluent Platform.
...
- [EventBus(stars: 1480)](https://github.com/asaskevich/EventBus) - The lightweight event bus with async compatibility.
...
- [gorush(stars: 7182)](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).
...
- [machinery(stars: 6954)](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.
...
- [melody(stars: 3236)](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- [Mercure(stars: 3447)](https://github.com/dunglas/mercure) - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [NATS Go Client(stars: 4689)](https://github.com/nats-io/nats) - Lightweight and high performance publish-subscribe and distributed queueing messaging system - this is the Go library.
...
- [sarama(stars: 10225)](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
...
- [Watermill(stars: 5979)](https://github.com/ThreeDotsLabs/watermill) - Working efficiently with message streams. Building event driven applications, enabling event sourcing, RPC over messages, sagas. Can use conventional pub/sub implementations like Kafka or RabbitMQ, but also HTTP or MySQL binlog.
...
- [unioffice(stars: 3918)](https://github.com/unidoc/unioffice) - Pure go library for creating and processing Office Word (.docx), Excel (.xlsx) and Powerpoint (.pptx) documents.

### Microsoft Excel

_Libraries for working with Microsoft Excel._

- [excelize(stars: 15675)](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig(stars: 3325)](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
- [dingo(stars: 163)](https://github.com/i-love-flamingo/dingo) - A dependency injection toolkit for Go, based on Guice.
- [do(stars: 1198)](https://github.com/samber/do) - A dependency injection framework based on Generics.
- [fx(stars: 4253)](https://github.com/uber-go/fx) - A dependency injection based application framework for Go (built on top of dig).
...
- [google/wire(stars: 11084)](https://github.com/google/wire) - Automated Initialization in Go.
...
- [ardanlabs/service(stars: 2823)](https://github.com/ardanlabs/service) - A [starter kit](https://github.com/ardanlabs/service/wiki) for building production grade scalable web service applications.
...
- [go-starter(stars: 364)](https://github.com/allaboutapps/go-starter) - An opinionated production-ready RESTful JSON backend template, highly integrated with VSCode DevContainers.
- [go-todo-backend(stars: 244)](https://github.com/Fs02/go-todo-backend) - Go Todo Backend example using modular project layout for product microservice.
...
- [golang-standards/project-layout(stars: 41150)](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
...
- [modern-go-application(stars: 1635)](https://github.com/sagikazarmark/modern-go-application) - Go application boilerplate and example applying modern practices.
- [pagoda(stars: 874)](https://github.com/mikestefanello/pagoda) - Rapid, easy full-stack web development starter kit built in Go.
...
- [base64Captcha(stars: 1830)](https://github.com/mojocn/base64Captcha) - Base64captch supports digit, number, alphabet, arithmetic, audio and digit-alphabet captcha.
...
- [gatus(stars: 3965)](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
- [go-resiliency(stars: 1841)](https://github.com/eapache/go-resiliency) - Resiliency patterns for golang.
- [go-unarr(stars: 245)](https://github.com/gen2brain/go-unarr) - Decompression library for RAR, TAR, ZIP and 7z archives.
- [gofakeit(stars: 3234)](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
- [gommit(stars: 103)](https://github.com/antham/gommit) - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil(stars: 9336)](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [shoutrrr(stars: 685)](https://github.com/containrrr/shoutrrr) - Notification library providing easy access to various messaging services like slack, mattermost, gotify and smtp among others.
...
- [gojieba(stars: 2196)](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
- [dns(stars: 7139)](https://github.com/miekg/dns) - Go library for working with DNS.
- [dnsmonster(stars: 273)](https://github.com/mosajjal/dnsmonster) - Passive DNS Capture/Monitoring Framework.
- [easytcp(stars: 712)](https://github.com/DarthPestilane/easytcp) - A light-weight TCP framework written in Go (Golang), built with message router. EasyTCP helps you build a TCP server easily fast and less painful.
...
- [event(stars: 146)](https://github.com/cheng-zhongliang/event) - Simple I/O event notification library wirtten in Golang.
- [fasthttp(stars: 19966)](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
- [fortio(stars: 2987)](https://github.com/fortio/fortio) - Load testing library and command line tool, advanced echo server and web UI. Allows to specify a set query-per-second load and record latency histograms and other useful stats and graph them. Tcp, Http, gRPC.
...
- [gmqtt(stars: 895)](https://github.com/DrmagicE/gmqtt) - Gmqtt is a flexible, high-performance MQTT broker library that fully implements the MQTT protocol V3.1.1.
- [gnet(stars: 7936)](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [minio(stars: 40363)](https://github.com/minio/minio) - Minio is a distributed object storage server.
...
- [awesome-awesomeness(stars: 30471)](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
...
- [Golang for Node.js Developers(stars: 3973)](https://github.com/miguelmota/golang-for-nodejs-developers) - Examples of Golang compared to Node.js for learning.
