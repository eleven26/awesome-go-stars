...
- [prometheus(stars: 51190)](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
...
- [go-sqlite3(stars: 7124)](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that uses database/sql.
...
- [ticker(stars: 4725)](https://github.com/achannarasappa/ticker) - Terminal stock watcher and stock position tracker.
...
- [mo(stars: 2042)](https://github.com/samber/mo) - Monads and popular FP abstractions, based on Go 1.18+ Generics (Option, Result, Either...).
...
- [Ebitengine(stars: 9278)](https://github.com/hajimehoshi/ebiten) - dead simple 2D game engine in Go.
- [engo(stars: 1687)](https://github.com/EngoEngine/engo) - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
- [fantasyname(stars: 25)](https://github.com/s0rg/fantasyname) - Fantasy names generator.
- [g3n(stars: 2549)](https://github.com/g3n/engine) - Go 3D Game Engine.
...
- [nano(stars: 2572)](https://github.com/lonng/nano) - Lightweight, facility, high performance golang based game server framework.
- [Oak(stars: 1469)](https://github.com/oakmound/oak) - Pure Go game engine.
- [Pitaya(stars: 2051)](https://github.com/topfreegames/pitaya) - Scalable game server framework with clustering support and client libraries for iOS, Android, Unity and others through the C SDK.
...
- [ants(stars: 11535)](https://github.com/panjf2000/ants) - A high-performance and low-cost goroutine pool in Go.
...
- [conc(stars: 7878)](https://github.com/sourcegraph/conc) - `conc` is your toolbelt for structured concurrency in go, making common tasks easier and safer.
...
- [app(stars: 7476)](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
...
- [fyne(stars: 22155)](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go based on Material Design. Supports: Linux, macOS, Windows, BSD, iOS and Android.
...
- [qt(stars: 10077)](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).
...
- [webview(stars: 11727)](https://github.com/zserge/webview) - Cross-platform webview window with simple two-way JavaScript bindings (Windows / macOS / Linux).
...
- [gg(stars: 4177)](https://github.com/fogleman/gg) - 2D rendering in pure Go.
...
- [gocv(stars: 5947)](https://github.com/hybridgroup/gocv) - Go package for computer vision using OpenCV 3.3+.
...
- [gowitness(stars: 2490)](https://github.com/sensepost/gowitness) - Screenshoting webpages using go and headless chrome on command line.
...
- [logrus(stars: 23617)](https://github.com/Sirupsen/logrus) - Structured logger for Go.
...
- [spew(stars: 5803)](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging.
...
- [zap(stars: 20246)](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
...
- [zerolog(stars: 9201)](https://github.com/rs/zerolog) - Zero-allocation JSON logger.
...
- [gorse(stars: 7800)](https://github.com/zhenghaoz/gorse) - An offline recommender system backend based on collaborative filtering written in Go.
...
- [Asynq(stars: 7905)](https://github.com/hibiken/asynq) - A simple, reliable, and efficient distributed task queue for Go built on top of Redis.
...
- [Centrifugo(stars: 7585)](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
- [gorush(stars: 7419)](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).
...
- [melody(stars: 3384)](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
- [Mercure(stars: 3609)](https://github.com/dunglas/mercure) - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).
...
- [sarama(stars: 10659)](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
...
- [excelize(stars: 16447)](https://github.com/xuri/excelize) - Golang library for reading and writing Microsoft Excel&trade; (XLSX) files.
...
- [dig(stars: 3537)](https://github.com/uber-go/dig) - A reflection based dependency injection toolkit for Go.
- [dingo(stars: 171)](https://github.com/i-love-flamingo/dingo) - A dependency injection toolkit for Go, based on Guice.
- [do(stars: 1418)](https://github.com/samber/do) - A dependency injection framework based on Generics.
...
- [google/wire(stars: 11713)](https://github.com/google/wire) - Automated Initialization in Go.
...
- [go-todo-backend(stars: 275)](https://github.com/Fs02/go-todo-backend) - Go Todo Backend example using modular project layout for product microservice.
...
- [golang-standards/project-layout(stars: 43684)](https://github.com/golang-standards/project-layout) - Set of common historical and emerging project layout patterns in the Go ecosystem. Note: despite the org-name they do not represent official golang standards, see [this issue](https://github.com/golang-standards/project-layout/issues/117) for more information. Nonetheless, some may find the layout useful.
...
- [nunu(stars: 860)](https://github.com/go-nunu/nunu) - Nunu is a scaffolding tool for building Go applications. 
...
- [gatus(stars: 4290)](https://github.com/TwinProduction/gatus) - Automated service health dashboard.
...
- [gofakeit(stars: 3885)](https://github.com/brianvoe/gofakeit) - Random data generator written in go.
- [gommit(stars: 106)](https://github.com/antham/gommit) - Analyze git commit messages to ensure they follow defined patterns.
- [gopsutil(stars: 9717)](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
...
- [fasthttp(stars: 20534)](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.
...
- [gnet(stars: 8284)](https://github.com/panjf2000/gnet) - `gnet` is a high-performance, lightweight, non-blocking, event-driven networking framework written in pure Go.
...
- [mdns(stars: 1068)](https://github.com/hashicorp/mdns) - Simple mDNS (Multicast DNS) client/server library in Golang.
...
- [netpoll(stars: 3767)](https://github.com/cloudwego/netpoll) - A high-performance non-blocking I/O networking framework, which focused on RPC scenarios, developed by ByteDance.
...
- [quic-go(stars: 9063)](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.
...
- [webrtc(stars: 12127)](https://github.com/pions/webrtc) - A pure Go implementation of the WebRTC API.
...
- [req(stars: 3834)](https://github.com/imroc/req) - Simple Go HTTP client with Black Magic (Less code and More efficiency).
...
- [GORM(stars: 34447)](https://github.com/go-gorm/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
...
- [Prisma(stars: 1785)](https://github.com/prisma/prisma-client-go) - Prisma Client Go, Typesafe database access for Go.
...
- [SQLBoiler(stars: 6192)](https://github.com/volatiletech/sqlboiler) - ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
- [dasel(stars: 4677)](https://github.com/tomwright/dasel) - Query and update data structures using selectors from the command line. Comparable to jq/yq but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
- [graphql-go(stars: 9558)](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.
...
- [age(stars: 14568)](https://github.com/FiloSottile/age) - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
...
- [Cameradar(stars: 3745)](https://github.com/Ullaakut/cameradar) - Tool and library to remotely hack RTSP streams from surveillance cameras.
...
- [Coraza(stars: 1570)](https://github.com/corazawaf/coraza) - Enterprise-ready, modsecurity and OWASP CRS compatible WAF library.
...
- [lego(stars: 6633)](https://github.com/go-acme/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt).
...
- [mapstructure(stars: 7366)](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
- [algernon(stars: 2518)](https://github.com/xyproto/algernon) - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
- [Caddy(stars: 51354)](https://github.com/caddyserver/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
- [consul](https://www.consul.io/) - Consul is a tool for service discovery, monitoring and configuration.
- [cortex-tenant(stars: 83)](https://github.com/blind-oracle/cortex-tenant) - Prometheus remote write proxy that adds add Cortex tenant ID header based on metric labels.
...
- [etcd(stars: 45462)](https://github.com/etcd-io/etcd) - Highly-available key value store for shared configuration and service discovery.
...
- [Fider(stars: 2479)](https://github.com/getfider/fider) - Fider is an open platform to collect and organize customer feedback.
- [Flagr(stars: 2302)](https://github.com/checkr/flagr) - Flagr is an open-source feature flagging and A/B testing service.
- [flipt(stars: 3082)](https://github.com/markphelps/flipt) - A self contained feature flag solution written in Go and Vue.js
...
- [minio(stars: 42302)](https://github.com/minio/minio) - Minio is a distributed object storage server.
...
- [maroto(stars: 1320)](https://github.com/johnfercher/maroto) - A maroto way to create PDFs. Maroto is inspired in Bootstrap and uses gofpdf. Fast and simple.
- [pongo2(stars: 2717)](https://github.com/flosch/pongo2) - Django-like template-engine for Go.
- [quicktemplate(stars: 2940)](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
...
- [templ(stars: 4370)](https://github.com/a-h/templ) - A HTML templating language that has great developer tooling.
...
- Testing Frameworks
  ...
  - [go-cmp(stars: 3840)](https://github.com/google/go-cmp) - Package for comparing Go values in tests.
  ...
  - [Testify(stars: 21209)](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
...
- Mock
  ...
  - [go-sqlmock(stars: 5627)](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions.
  ...
  - [mockery(stars: 5314)](https://github.com/vektra/mockery) - Tool to generate Go interfaces.
...
- [go-humanize(stars: 3883)](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.
...
- [sh(stars: 6412)](https://github.com/mvdan/sh) - Shell parser and formatter.
...
- [bluemonday(stars: 2871)](https://github.com/microcosm-cc/bluemonday) - HTML Sanitizer.
- [gofuckyourself(stars: 59)](https://github.com/JoshuaDoes/gofuckyourself) - A sanitization-based swear filter for Go.

### Scrapers

- [colly(stars: 21404)](https://github.com/asciimoo/colly) - Fast and Elegant Scraping Framework for Gophers.
...
- [GoQuery(stars: 13233)](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
...
- [aws-sdk-go(stars: 2243)](https://github.com/aws/aws-sdk-go-v2) - The official AWS SDK for the Go programming language.
...
- [discordgo(stars: 4453)](https://github.com/bwmarrin/discordgo) - Go bindings for the Discord Chat API.
...
- [go-openai(stars: 7407)](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, DALL·E, Whisper API library for Go.
...
- [slack(stars: 4468)](https://github.com/slack-go/slack) - Slack API in Go.
...
- [air(stars: 13316)](https://github.com/cosmtrek/air) - Air - Live reload for Go apps.
...
- [clockwork(stars: 564)](https://github.com/jonboulle/clockwork) - A simple fake clock for golang.
...
- [dive(stars: 39964)](https://github.com/wagoodman/dive) - A tool for exploring each layer in a Docker image.
...
- [fzf(stars: 56423)](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.
...
- [go-funk(stars: 4502)](https://github.com/thoas/go-funk) - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...).
...
- [goreleaser(stars: 12431)](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible.
...
- [hub(stars: 22604)](https://github.com/github/hub) - wrap git commands with additional functionality to interact with github from the terminal.
...
- [lancet(stars: 3338)](https://github.com/duke-git/lancet) - A comprehensive, efficient, and reusable util function library of go.
...
- [lo(stars: 14306)](https://github.com/samber/lo) - A Lodash like Go library based on Go 1.18+ Generics (map, filter, contains, find...)
...
- [mimetype(stars: 1309)](https://github.com/gabriel-vasile/mimetype) - Package for MIME type detection based on magic numbers.
...
- [peco(stars: 7493)](https://github.com/peco/peco) - Simplistic interactive filtering tool.
...
- [scany(stars: 1093)](https://github.com/georgysavva/scany) - Library for scanning data from a database into Go structs and more.
...
- [sqlx(stars: 14784)](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
...
- [usql(stars: 8379)](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.
...
- [wuzz(stars: 10410)](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.
...
- [ulid(stars: 3922)](https://github.com/oklog/ulid) - Go implementation of ULID (Universally Unique Lexicographically Sortable Identifier).
...
- [uuid(stars: 4783)](https://github.com/google/uuid) - Go package for UUIDs based on RFC 4122 and DCE 1.1: Authentication and Security Services.
...
- [validator(stars: 14730)](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
- [go-git(stars: 5238)](https://github.com/go-git/go-git) - highly extensible Git implementation in pure Go.
...
- [gortsplib(stars: 537)](https://github.com/aler9/gortsplib) - Pure Go RTSP server and client library.
...
- [Beego(stars: 30501)](https://github.com/beego/beego) - beego is an open-source, high-performance web framework for the Go programming language.
...
- [Echo(stars: 27454)](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
- [Fiber(stars: 29739)](https://github.com/gofiber/fiber) - An Express.js inspired web framework build on Fasthttp.
...
- [Gin(stars: 73332)](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
...
- [chi(stars: 16208)](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
...
- [httprouter(stars: 16023)](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.
...
- [mux(stars: 19695)](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
...
- [Cosign(stars: 3801)](https://github.com/sigstore/cosign) - Container Signing, Verification and Storage in an OCI registry.
...
- [vscode-go(stars: 3633)](https://github.com/golang/vscode-go) - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
- [go-callvis(stars: 5554)](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.
...
- [go-swagger(stars: 9061)](https://github.com/go-swagger/go-swagger) - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
...
- [bombardier(stars: 4973)](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
...
- [Fleet device management(stars: 1768)](https://github.com/fleetdm/fleet) - Lightweight, programmable telemetry for servers and workstations.
...
- [Gitea(stars: 39894)](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
...
- [GVM(stars: 9174)](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
- [Hey(stars: 16742)](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
...
- [k3d(stars: 4843)](https://github.com/k3d-io/k3d) - Little helper to run CNCF's k3s in Docker.
- [k3s(stars: 25376)](https://github.com/k3s-io/k3s) - Lightweight Kubernetes.
- [k6(stars: 22327)](https://github.com/grafana/k6) - A modern load testing tool, using Go and JavaScript.
...
- [kind(stars: 12346)](https://github.com/kubernetes-sigs/kind) - Kubernetes IN Docker - local clusters for testing Kubernetes.
- [ko(stars: 6845)](https://github.com/google/ko) - Command line tool for building and deploying Go applications on Kubernetes
- [kool(stars: 658)](https://github.com/kool-dev/kool) - Command line tool for managing Docker environments as an easy way.
- [kubernetes(stars: 104123)](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
- [kubeshark(stars: 10179)](https://github.com/kubeshark/kubeshark) - API traffic analyzer for Kubernetes, inspired by Wireshark, purposely built for Kubernetes.
- [KubeVela(stars: 5828)](https://github.com/kubevela/kubevela) - Cloud native application delivery.
...
- [minikube(stars: 27759)](https://github.com/kubernetes/minikube) - Run Kubernetes locally.
- [Moby(stars: 67106)](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.
...
- [traefik(stars: 45995)](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
...
- [Vegeta(stars: 22300)](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
...
- [webhook(stars: 9534)](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
- [blocky(stars: 3230)](https://github.com/0xERR0R/blocky) - Fast and lightweight DNS proxy as ad-blocker for local network with many features.
...
- [croc(stars: 25329)](https://github.com/schollz/croc) - Easily and securely send files or folders from one computer to another.
...
- [Duplicacy(stars: 4847)](https://github.com/gilbertchen/duplicacy) - A cross-platform network and cloud backup tool based on the idea of lock-free deduplication.
...
- [lgo(stars: 2336)](https://github.com/yunabe/lgo) - Interactive Go programming with Jupyter. It supports code completion, code inspection and 100% Go compatibility.
...
- [nes(stars: 5331)](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.
...
- [restic(stars: 21992)](https://github.com/restic/restic) - De-duplicating backup program.
- [sake(stars: 632)](https://github.com/alajmo/sake) - sake is a command runner for local and remote hosts.
- [scc(stars: 5345)](https://github.com/boyter/scc) - Sloc Cloc and Code, a very fast accurate code counter with complexity calculations and COCOMO estimates.
- [Seaweed File System(stars: 18930)](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
- [GoBooks(stars: 15356)](https://github.com/dariubs/GoBooks) - A curated list of Go books.
...
- [Free Gophers Pack(stars: 3217)](https://github.com/MariaLetta/free-gophers-pack) - Gopher graphics pack by Maria Letta with illustrations and emotional characters in vector and raster.
...
- [Awesome Remote Job(stars: 27209)](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them are looking for Go hackers.
- [awesome-awesomeness(stars: 30924)](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
...
- [Build web application with Golang(stars: 42586)](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
...
- [go-patterns(stars: 23335)](https://github.com/tmrts/go-patterns) - Curated list of Go design patterns, recipes and idioms.
...
- [Learn Go with 1000+ Exercises(stars: 17985)](https://github.com/inancgumus/learngo) - Learn Go with thousands of examples, exercises, and quizzes.
- [Learn Go with TDD(stars: 20645)](https://github.com/quii/learn-go-with-tests) - Learn Go with test-driven development.
